...
export const LORE_NOTES: readonly LoreNoteDef[] = Object.freeze([
  ...
  Object.freeze({ id: "glass-note-1", title: "Ice Etching", regionHint: "glass-caldera", text: "The plates sing at dusk. Do not camp on the mirror disc." }),
  Object.freeze({ id: "heath-note-1", title: "Bronze Rubbing", regionHint: "copperleaf-basin", text: "Amphitheater seals when the sun drops. Leave by the gate gap." }),
  Object.freeze({ id: "cataract-note-1", title: "Cable Tag", regionHint: "silt-cataract", text: "Span fail year mark still shows. Ford only at foam line." }),
